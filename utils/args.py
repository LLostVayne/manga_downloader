...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("-l","--latest", action="store_true", help="Download the latest chapter")
    parser.add_argument("-a","--all", action="store_true", help="Download all chapters")
    ...
    parser.add_argument("--range", metavar="<1:4|:5|4:>", help="Specify range of chapters to download")
    # parser.add_argument("--url", metavar="<https://mangakatana.com/...>", help="")
    # parser.add_argument("--read", metavar="<input.txt>", help="")
